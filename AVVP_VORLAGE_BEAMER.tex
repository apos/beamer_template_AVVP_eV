...
\subsection{Video}
\begin{frame}[fragile]{Video per Youtube-Link }

\href{https://www.youtube.com/watch?v=eTOM_303DC8}{
  \includegraphics[width=\linewidth]{media/AVVP_Universe_on_tour_2024_gdrive.png}
}

\AVVPCreditOverlay{youtube-heyapos-intro-2025}
\end{frame}
%
\begin{frame}[fragile]{Video - Google-Drive}
...
\end{frame}
%
\begin{frame}[fragile]{Video - lokale MP4 Datei}
