  ...
  \usebackgroundtemplate{%
    \begin{tikzpicture}[remember picture,overlay]
      ...
      \node[
        ...
        at ([xshift=-6pt,yshift=24pt]current page.south east)
        {%
          \rotatebox{90}{%
...
%     - local file:   run:media/<file>.mp4
%     - URL:          https://...
% Notes:
% - PDF viewers may block "run:" links for security reasons.
...
\newcommand{\AVVPVideoLocal}[3][]{%
  \begin{center}%
    \href{run:#2}{\AVVPVideoPoster[#1]{#3}}\\[0.4ex]%
    {\footnotesize\href{run:#2}{\texttt{\path{#2}}}}%
  \end{center}%
}
